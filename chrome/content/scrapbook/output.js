...
var sbOutputService = {
    ...
    getHTMLFrame : function()
    {
        var HTML = '<!DOCTYPE html>\n'
            ...
            + 'iframe { width: 100%; height: 100%; margin: 0; border: 0; }\n'
            + '#wrapper { height: 100%; clear: both; overflow: hidden; }\n'
            + '#overlay { width: 100%; height: 100%; background-color: #cff; opacity: 0.5; position: absolute; z-index: 100; cursor: ew-resize; display: none; }\n'
            + '#left { width: 200px; }\n'
            + '#left, #right { height: 100%; float: left; }\n'
            + '#splitter { left: 200px; height: 100%; float: left; border-left: 2px outset brown; border-right: 2px outset brown; position: absolute; z-index: 101; cursor: ew-resize; }\n'
            + '</style>\n'
            + '<script>\n'
            + 'var leftFrameWidth;\n'
            + '\n'
            ...
            + '    renewFrameSize();\n'
            + '    makeDraggable(document.getElementById("splitter"));\n'
            + '};\n'
            + '\n'
            ...
            + '    }\n'
            + '    w -= document.getElementById("splitter").offsetWidth;\n'
            + '\n'
            + '    if (typeof x !== "undefined") leftFrameWidth = x;\n'
            + '    var w1 = (typeof leftFrameWidth !== "undefined") ? leftFrameWidth : Math.min(200, 0.3*w), w2 = w - w1;\n'
            + '    document.getElementById("left").style.width = w1 + "px";\n'
            + '    document.getElementById("right").style.width = w2 + "px";\n'
            + '    document.getElementById("splitter").style.left = w1 + "px";\n'
            + '}\n'
            + '\n'
            ...
            + '    e = e || window.event;\n'
            + '    renewFrameSize(e.clientX, e.clientY);\n'
            + '}\n'
            + '\n'
            + 'function mouseUp(){\n'
            ...
            + '<div id="wrapper">\n'
            + '    <div id="overlay"></div>\n'
            + '    <div id="left"><iframe name="side" src="index.html"></iframe></div>\n'
            + '    <div id="splitter"></div>\n'
            + '    <div id="right"><iframe name="main"></iframe></div>\n'
            + '</div>\n'
            + '</body>\n'
            + '</html>\n';
        return HTML;
